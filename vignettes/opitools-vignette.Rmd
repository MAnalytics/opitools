...
# Real-life example datasets

In order to demonstrate the potentials of `opitools` for application across a wide variety of domains, the following example datasets are collected for the demonstration:
