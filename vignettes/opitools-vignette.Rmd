...
The development of `'opitools'` is instigated by the lack of tools for carrying out opinion impact analysis of a digital text document (DTD). The package functions can be categorized into two groups, namely (1) exploratory - for exploring terms in a document, e.g. word importance and statistical distribution, and (2) analytical - for computing metrics in an impact analysis. The application of `opitools` across widely distinct domains, including law enforcement, transport and politics, is shown demonstrated in this vignette.  
