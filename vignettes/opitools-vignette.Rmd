...
col3 <- c("`Twitter posts`","`Customer reviews`", "`debate comments`")
...
knitr::kable(tble1, caption = "Table 1. `Example datasets`", col.names = c("SN","Data","Description","Details", "Data Source")) %>%
